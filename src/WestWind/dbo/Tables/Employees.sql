CREATE TABLE [dbo].[Employees] (
    ...
    [Notes]           NTEXT           NULL,
    [Active]          BIT             CONSTRAINT [DF_Employees__Active] DEFAULT ((1)) NULL,
    [TerminationDate] DATETIME        NULL,
    [OnLeave]         BIT             CONSTRAINT [DF_Employees_OnLeave] DEFAULT ((0)) NOT NULL,
    ...
    CONSTRAINT [UX_Employees_AddressID] UNIQUE ([AddressID])
);
